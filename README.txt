...
3.provide the suitable entry's in the file .\WAP_MVC_SUMANTA\WEB-INF\classes\DAO\Config.txt.
"login table" and "message table" are the tablenames for storing Users(varchar,varchar)" and
"Comments(Varchar,varchar,varchar)".
